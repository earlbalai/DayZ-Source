...
if (isServer) then {
	_eh3 = _unit addEventHandler ["GetOut", {[(_this select 0),"damage",true] call server_updateObject;}];
	_eh4 = _unit addEventHandler ["GetIn", {[(_this select 0),"damage",true] call server_updateObject;}];
