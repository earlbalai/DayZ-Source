class Fishing_Boat: Ship {
	...
	vehicleclass = "Ship";
	class Library {
		libtextdesc = "Simple boat used to catch fish in the sea. <br/>According to the international Food and Agriculture Organization there are about 4 million of commercial fishing boats worldwide. This is one of them.";
	};
	class Turrets {
	};
	class SoundEvents {
